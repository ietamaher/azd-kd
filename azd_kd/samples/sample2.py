...
from azd_kd.msg import Query
from azd_kd.msg import Response
from azd_kd.msg import State
...
class MySubscription(Node):
    def __init__(self):
        ...
        self.sub1 = self.create_subscription(
            Response, "azd_kd_response", self.response_callback, 1
        )
        self.sub2 = self.create_subscription(
            State, "azd_kd_state", self.state_callback, 1
        )
...
class MyPublisher(Node):
    def __init__(self):
        ...
        self.seq = 0
        self.pub = self.create_publisher(Query, "azd_kd_query", 1)
